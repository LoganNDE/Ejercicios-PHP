          ...
          <div class="col bg-light rounded border p-4">
            <form action="login-check.php" method="POST">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="user" value="<?php echo $userRemember; ?>" name="user" placeholder="Ingresa tu usuario">
              </div>
              <div class="form-group pt-3 pb-1">
                <label for="password">Contraseña</label>
                <input type="password" class="form-control" id="password" value="<?php echo $passwordRemember; ?>" name="password" placeholder="Contraseña">
              </div>
